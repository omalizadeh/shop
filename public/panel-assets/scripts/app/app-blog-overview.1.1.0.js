...
(function ($) {
    $(document).ready(function () {
        ...
        from = $(".date-from").persianDatepicker({
            inline: false,
            altField: '.date-from',
            altFormat: 'LLLL',
            initialValue: false,
        ...
        Chart.defaults.global.defaultFontFamily = 'Vazir FD'
        ...
        boSmallStatsDatasets.map(function (el, index) {
            ...
            new Chart(ctx, {
                type: 'line',
                data: {
                    labels: ["لیبل 1", "لیبل 2", "لیبل 3", "لیبل 4", "لیبل 5", "لیبل 6", "لیبل 7"],
                    datasets: [{
                        label: 'امروز',
                        fill: 'start',
                        data: el.data,
