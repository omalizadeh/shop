...
return [
    ...
    */
    'recaptcha' => 'تصویر امنیتی ثبت نشده است.',
    ...
    'mimes' => ' پسوند :attribute باید: :values باشد',
    ...
    'not_in_route' => 'مقدار :attribute قابل استفاده نیست.',
    'image_size_invalid' => 'لطفا اندازه تصویر را از منو انتخاب کرده و سپس عرض و ارتفاع را فقط بصورت عددی در کادرهای مربوطه وارد نمائید',
    ...
    */
    ...
    'attributes' => [
        ...
        "feature_group" => "گروه ویژگی",
        "feature_group_id" => "گروه ویژگی",
        "feature" => "ویژگی",
        "feature_id" => "ویژگی",
    ],
